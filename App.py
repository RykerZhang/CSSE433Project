...
def getCandidates():
    if not isOpen("433-34.csse.rose-hulman.edu", 7474):
        print("down")
        return {"message": "down"}
...
# Function haven't been routed yet: (neo4j create node , relation and portToNeo4jdelete node with repetition check )
